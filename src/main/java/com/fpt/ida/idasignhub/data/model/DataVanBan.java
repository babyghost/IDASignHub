...
public class DataVanBan {
    ...
    public DataVanBan(Integer stt, String hoSoId, String hoSo, String tenVanBan, String vanBanId, String path, Integer soTrang, Integer soToA0, Integer soToA1, Integer soToA2, Integer soToA3, Integer soToA4, Integer soToA5) {
        this.stt = stt;
        this.hoSoId = hoSoId;
        this.hoSo = hoSo;
    ...
    public Integer getSizeOther() {
        return sizeOther;
    }

    public void setSizeOther(Integer sizeOther) {
